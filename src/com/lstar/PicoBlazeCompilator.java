...
public class PicoBlazeCompilator {
    public static Map<String, String> constant;
    public static Map<String, String> namereg;
    public static Map<String, Integer> call;
    ...
    //Constructor
    PicoBlazeCompilator(String filename){

        if(filename.equals("sh")) {
            try {
                new HarlemShake();
            } catch (IOException e) {
                e.printStackTrace();
            ...
            namereg = new TreeMap<String, String>();
            call = new TreeMap<String, Integer>();
    ...
    //Accord compilator row numbers and call numbers
    private void assignComRowNum(){
        for(PBLine elem : lines){
            if(elem.getCallName() != null){
                if(call.containsKey(elem.getCallName())){
                    call.put(elem.getCallName(), compillableRowNumber);
                }else{
    ...
    public void printConstantsandNameregs(){
        System.out.println("Constants: " + constant.toString());
        System.out.println("Nameregs: " + namereg.toString());
